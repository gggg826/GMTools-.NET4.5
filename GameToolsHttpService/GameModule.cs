            ...
            try
            {
                ...
                if (serverList.Count > 0)
                {
                    ...
                    if (!string.IsNullOrEmpty(serverIP))
                    {
                        ...
                        string errorContent = FengNiao.GameTools.Json.Serialize.GetJsonObject<string>(contentObj, "result").Replace("roleid:", ""); ;
                        if (errorcode == 0)
                        {
                            //发送成功入库
                            ...
                            mailDBModel.user = mailModel.user;
                        ...
                        {
                            requestResult.IsSuccess = false;
                            requestResult.Content = errorContent;
