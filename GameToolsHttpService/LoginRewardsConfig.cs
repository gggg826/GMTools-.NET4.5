...
{
    public class LoginRewardsConfig : ProcessRequestBase
    {
        public LoginRewardsConfig(string tableName)
            : base(tableName)
        {
        }
        public override string Add(HttpContext context)
        {
            ...
            try
            { 
                List<FengNiao.GMTools.Database.Model.tbl_login_rewards_config> configModels = FengNiao.GameTools.Json.Serialize.ConvertJsonToObjectList<FengNiao.GMTools.Database.Model.tbl_login_rewards_config>(strModel);
                FengNiao.GMTools.Database.BLL.tbl_login_rewards_config loginrewardsConfigBLL = new FengNiao.GMTools.Database.BLL.tbl_login_rewards_config();

                //List<FengNiao.GMTools.Database.Model.tbl_login_rewards_config> configs = loginrewardsConfigBLL.GetModelList("serverID = " + configModel.serverID + " and date = " + configModel.date);

                //foreach (FengNiao.GMTools.Database.Model.tbl_login_rewards_config item in configModels)
                    //loginrewardsConfigBLL.DeleteByServer(item.serverID);
                ...
                try
                {
                    string serverIP = serverip;
                        if (!string.IsNullOrEmpty(serverIP))
                        {
                            ...
                            string strArgs = "cmd=reload_loginreward";
        ...
        public override string Update(HttpContext context)
        {
            ...
            try
            {
                ...
                List<FengNiao.GMTools.Database.Model.tbl_login_rewards_config> newConfigList = FengNiao.GameTools.Json.Serialize.ConvertJsonToObject<List<FengNiao.GMTools.Database.Model.tbl_login_rewards_config>>(strModel);
                ...
                FengNiao.GMTools.Database.BLL.tbl_login_rewards_config ConfigConfigBLL = new FengNiao.GMTools.Database.BLL.tbl_login_rewards_config();
                int server = int.Parse(server_id);
                ConfigConfigBLL.DeleteByServer(server);

                if (newConfigList.Count != 0)
                {
                    foreach (FengNiao.GMTools.Database.Model.tbl_login_rewards_config configModel in newConfigList)
                    {
        ...
        private void Send(FengNiao.GMTools.Database.Model.tbl_server server, List<FengNiao.GMTools.Database.Model.tbl_login_rewards_config> models)
        {
            FengNiao.GMTools.Database.BLL.tbl_login_rewards_config ConfigBLL = new FengNiao.GMTools.Database.BLL.tbl_login_rewards_config();

            ConfigBLL.DeleteByServer(server.fld_server_id);
            if (models != null)
            {
                foreach (FengNiao.GMTools.Database.Model.tbl_login_rewards_config item in models)
                {
                    FengNiao.GMTools.Database.Model.tbl_login_rewards_config model = item;
    ...
    //public override string Update(HttpContext context)
        ...
        //    try
        //    {
        //        FengNiao.GMTools.Database.Model.tbl_login_rewards_config configModel = FengNiao.GameTools.Json.Serialize.ConvertJsonToObject<FengNiao.GMTools.Database.Model.tbl_login_rewards_config>(strModel);
        //        if (configModel != null)
        //        {
        //            FengNiao.GMTools.Database.BLL.tbl_login_rewards_config activityConfigBLL = new FengNiao.GMTools.Database.BLL.tbl_login_rewards_config();
