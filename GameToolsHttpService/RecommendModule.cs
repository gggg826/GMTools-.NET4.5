...
namespace GameToolsHttpService
{
    public class RecommendModule : ProcessRequestBase
    {
        ...
        //    try
        //    {
        //        List<FengNiao.GMTools.Database.Model.tbl_recommend> configModels = FengNiao.GameTools.Json.Serialize.ConvertJsonToObjectList<FengNiao.GMTools.Database.Model.tbl_recommend>(strModel);
        ...
        //        {
        //            foreach (FengNiao.GMTools.Database.Model.tbl_recommend item in configModels)
        //                ConfigBLL.Add(item);
        ...
        private void Send(FengNiao.GMTools.Database.Model.tbl_server server, List<FengNiao.GMTools.Database.Model.tbl_recommend> models)
        {
            FengNiao.GMTools.Database.BLL.tbl_recommend ConfigBLL = new FengNiao.GMTools.Database.BLL.tbl_recommend();
    ...
    //        public AsyncThread(FengNiao.GMTools.Database.Model.tbl_server server, List<FengNiao.GMTools.Database.Model.tbl_recommend> models)
    //        {
    //            this.server = server;
    //            this.models = models;
