...
namespace FengNiao.GameTools.Util
{
    public sealed class HotKey
    {
        ...
        {
            [FieldOffset(0)]
            public RAWINPUTHEADER64 header;
            [FieldOffset(24)]
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct RAWINPUTHEADER64
        {
            [MarshalAs(UnmanagedType.U4)]
            public int dwType;
            [MarshalAs(UnmanagedType.U4)]
        ...
        {
            [FieldOffset(0)]
            public RAWINPUTHEADER32 header;
            [FieldOffset(16)]
            public RAWMOUSE mouse;
            [FieldOffset(16)]
            public RAWKEYBOARD keyboard;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct RAWINPUTHEADER32
        {
            [MarshalAs(UnmanagedType.U4)]
            public int dwType;
            [MarshalAs(UnmanagedType.U4)]
        ...
        public int EnumerateDevices(ref Hashtable devList)
        {
        ...
        public void ProcessInputCommand(Message message)
        {
            ...
            GetRawInputData(message.LParam,
                             ...
                             ref dwSize,
                             (uint)Marshal.SizeOf(typeof(RAWINPUTHEADER32)));
            ...
            try
            {
                if (buffer != IntPtr.Zero &&
                    GetRawInputData(message.LParam,
                                     ...
                                     buffer,
                                     ref dwSize,
                                     (uint)Marshal.SizeOf(typeof(RAWINPUTHEADER32))) == dwSize)
                {

                    RAWINPUT32 raw = (RAWINPUT32)Marshal.PtrToStructure(buffer, typeof(RAWINPUT32));

                    if (raw.header.dwType == RIM_TYPEKEYBOARD)
                    {
#if HOTKEY
                        Console.WriteLine(raw.keyboard.Message.ToString());
#endif
                        if (raw.keyboard.Message == WM_KEYDOWN || raw.keyboard.Message == WM_SYSKEYDOWN || raw.keyboard.Message == WM_KEYUP)
                        {
                            ...
                            {
                                if (raw.keyboard.Message != WM_KEYUP)
                                {
                                    if (KeyPressed != null)
                                    {
        ...
        {
            //Console.WriteLine("msg:" + message.Msg.ToString());
            switch (message.Msg)
            {
