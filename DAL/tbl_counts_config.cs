...
namespace FengNiao.GMTools.Database.DAL
{
    public partial class tbl_counts_config
    {
        ...
        public bool Add(FengNiao.GMTools.Database.Model.tbl_counts_config model)
        {
            ...
            strSql.Append("record_id,dataid,item_id,counts,describes,kindofrewards,reward1,count1,reward2,count2,reward3,count3,reward4,count4,serverID)");
        ...
        public List<FengNiao.GMTools.Database.Model.tbl_counts_config> GetAllModel()
        {
            ...
            strSql.Append("select record_id,dataid,item_id,counts,describes,kindofrewards,reward1,count1,reward2,count2,reward3,count3,reward4,count4,serverID");
        ...
        public List<FengNiao.GMTools.Database.Model.tbl_counts_config> GetALLModel()
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select record_id,dataid,item_id,counts,describe,kindofrewards,reward1,count1,reward2,count2,reward3,count3,reward4,count4,serverID from tbl_counts_config ");
