...
namespace FengNiao.GMTools.Database.DAL
{
	...
	public partial class tbl_listserver
	{
		...
		public bool Exists(long fld_record_id)
		{
			...
			strSql.Append("select count(1) from tbl_listserver");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(FengNiao.GMTools.Database.Model.tbl_listserver model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tbl_listserver(");
			strSql.Append("fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_version,fld_list_server_addr,fld_list_server_port)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@fld_list_server_addr", MySqlDbType.VarChar,255),
					new MySqlParameter("@fld_list_server_port", MySqlDbType.Int32,11)};
			...
			parameters[5].Value = model.fld_list_server_addr;
			parameters[6].Value = model.fld_list_server_port;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(FengNiao.GMTools.Database.Model.tbl_listserver model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tbl_listserver set ");
			...
			strSql.Append("fld_list_server_addr=@fld_list_server_addr,");
			strSql.Append("fld_list_server_port=@fld_list_server_port");
			strSql.Append(" where fld_record_id=@fld_record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@fld_create_time", MySqlDbType.DateTime),
					new MySqlParameter("@fld_deleted", MySqlDbType.Byte,4),
			...
			parameters[4].Value = model.fld_list_server_addr;
			parameters[5].Value = model.fld_list_server_port;
		...
		public bool Delete(long fld_record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tbl_listserver ");
			strSql.Append(" where fld_record_id=@fld_record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@fld_record_id", MySqlDbType.Int64)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_listserver GetModel(long fld_record_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fld_record_id,fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_version,fld_list_server_addr,fld_list_server_port from tbl_listserver ");
			strSql.Append(" where fld_record_id=@fld_record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@fld_record_id", MySqlDbType.Int64)
			};
			...
			FengNiao.GMTools.Database.Model.tbl_listserver model=new FengNiao.GMTools.Database.Model.tbl_listserver();
		...
		/// 得到一个对象实体
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_listserver DataRowToModel(DataRow row)
		{
			FengNiao.GMTools.Database.Model.tbl_listserver model=new FengNiao.GMTools.Database.Model.tbl_listserver();
			if (row != null)
			{
				...
				if(row["fld_list_server_addr"]!=null)
				{
					model.fld_list_server_addr=row["fld_list_server_addr"].ToString();
				}
				if(row["fld_list_server_port"]!=null && row["fld_list_server_port"].ToString()!="")
				{
					model.fld_list_server_port=int.Parse(row["fld_list_server_port"].ToString());
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fld_record_id,fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_version,fld_list_server_addr,fld_list_server_port ");
			strSql.Append(" FROM tbl_listserver ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tbl_listserver T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tbl_listserver";
