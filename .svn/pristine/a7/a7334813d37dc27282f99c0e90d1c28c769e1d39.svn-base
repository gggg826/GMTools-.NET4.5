...
namespace FengNiao.GMTools.Database.DAL
{
	...
	/// </summary>
	public partial class tbl_activity_config
	{
		public tbl_activity_config()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("record_id", "tbl_activity_config"); 
		}
		...
		public bool Exists(int record_id)
		{
			...
			strSql.Append("select count(1) from tbl_activity_config");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(FengNiao.GMTools.Database.Model.tbl_activity_config model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tbl_activity_config(");
			strSql.Append("id,isopen,starttime,stoptime,server_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(FengNiao.GMTools.Database.Model.tbl_activity_config model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tbl_activity_config set ");
			strSql.Append("id=@id,");
		...
		public bool Delete(int record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tbl_activity_config ");
			strSql.Append(" where record_id=@record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@record_id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_activity_config GetModel(int record_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select record_id,id,isopen,starttime,stoptime,server_id from tbl_activity_config ");
			strSql.Append(" where record_id=@record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@record_id", MySqlDbType.Int32)
			};
			...
			FengNiao.GMTools.Database.Model.tbl_activity_config model=new FengNiao.GMTools.Database.Model.tbl_activity_config();
		...
		/// 得到一个对象实体
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_activity_config DataRowToModel(DataRow row)
		{
			FengNiao.GMTools.Database.Model.tbl_activity_config model=new FengNiao.GMTools.Database.Model.tbl_activity_config();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select record_id,id,isopen,starttime,stoptime,server_id ");
			strSql.Append(" FROM tbl_activity_config ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tbl_activity_config T ");
