...
namespace FengNiao.GMTools.Database.BLL
{
    ...
    {
        private readonly FengNiao.GMTools.Database.DAL.tbl_proto_cout dal = new FengNiao.GMTools.Database.DAL.tbl_proto_cout();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public FengNiao.GMTools.Database.Model.tbl_proto_cout GetModelByCache(int record_id)
        //{
        ...
        //        catch { }
        //    }
        //    return (FengNiao.GMTools.Database.Model.tbl_proto_cout)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_proto_cout> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_proto_cout> DataTableToList(DataTable dt)
        {
            ...
            if (rowsCount > 0)
            {
                FengNiao.GMTools.Database.Model.tbl_proto_cout model;
