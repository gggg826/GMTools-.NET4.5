...
namespace FengNiao.GMTools.Database.DAL
{
    public partial class tbl_sucession_rewards_config
    {
		...
		public bool Add(FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config model)
		{
            ...
            strSql.Append("record_id,serverID,date,kindReward,rewardName1,rewardCount1,rewardName2,rewardCount2,rewardName3,rewardCount3,rewardName4,rewardCount4,dataid)");
            strSql.Append(" values (");
            strSql.Append("default,@serverID,@date,@kindReward,@rewardName1,@rewardCount1,@rewardName2,@rewardCount2,@rewardName3,@rewardCount3,@rewardName4,@rewardCount4,@dataid)");
            MySqlParameter[] parameters = {
		...
		public FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config GetModel(int record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select record_id,serverID,date,kindReward,rewardName1,rewardCount1,rewardName2,rewardCount2,rewardName3,rewardCount3,rewardName4,rewardCount4,dataid from tbl_sucession_rewards_config ");
			strSql.Append(" where record_id=@record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@record_id", MySqlDbType.Int32)
			};
