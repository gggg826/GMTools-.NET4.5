            ...
            switch (strCmd)
            {
                ...
                case "notice":
                    ...
                    for (int i = 0; i < notices.Count; i++)
                    {
                        ...
                        noticeModel.channel = notices[i].channel;
                ...
                case "first_recharge":
                    ...
                    for (int i = 0; i < first_recharges.Count; i++)
                    {
                        ...
                        List<FengNiao.GMTools.Database.Model.tbl_first_recharge> rechargeslist = tbl_first_rechargeBLL.GetModelList("record_id = " + first_recharges[i].recharge_record);
                ...
                case "loginreward":
                    ...
                    for (int i = 0; i < loginrewards.Count; i++)
                    {
                        ...
                        loginrewardModel.dataid = loginrewards[i].dataid;
                ...
                case "sucessreward":
                    ...
                    for (int i = 0; i < rewards.Count; i++)
                    {
                        ...
                        sucessrewardModel.dataid = rewards[i].dataid;
                ...
                case "solution":
                    ...
                    FengNiao.GMTools.Database.BLL.tbl_activity_solution solutionBLL = new FengNiao.GMTools.Database.BLL.tbl_activity_solution();
                    List<FengNiao.GMTools.Database.Model.tbl_activity_solution> allSolutions = solutionBLL.GetModelList("");
                    FengNiao.GMTools.Database.Model.tbl_activity_solution solution = new FengNiao.GMTools.Database.Model.tbl_activity_solution();
                    ...
                    if (allSolutions.Count > 0 )
                    {
                        ...
                        {
                            string[] servers = allSolutions[i].fld_servers.Split(';');
                            for (int j = 0; j < servers.Length; j++)
                            {
                                if(servers[j] == strServerID)
                                {
                    ...
                    FengNiao.GMTools.Database.BLL.tbl_activity_details activityDetailBLL = new FengNiao.GMTools.Database.BLL.tbl_activity_details();
                    List<FengNiao.GMTools.Database.Model.tbl_activity_details> activityDetails = activityDetailBLL.GetModelList("");
                    List<FengNiao.GMTools.Database.Model.tbl_activity_details> details = new List<FengNiao.GMTools.Database.Model.tbl_activity_details>();

                    for (int i = 0; i < activityDetails.Count; i++)
                    {
                        if (activityDetails[i].fld_solution_id == solution.fld_id)
                            details.Add(activityDetails[i]);
                    }

                    //List<SolutionModel> solutionList = new List<SolutionModel>();
                    SolutionArray solutionArr = new SolutionArray();
                    foreach (var item in details)
                    {
                        SolutionModel solutionMod = new SolutionModel();
                        solutionMod.id = item.fld_activity_id;
                        solutionMod.opentype = item.fld_open_type;
                        solutionMod.previewtime = item.fld_preview_time;
                        solutionMod.opentime = item.fld_open_time;
                        solutionMod.closetime = item.fld_close_time;
                        solutionMod.awardtime = item.fld_award_time;
                        solutionMod.dataid = item.fld_dataid;

                        //solutionList.Add(solutionMod);
                        solutionArr.Add(solutionMod);
                    }


                    string strDetails = FengNiao.GameTools.Json.Serialize.ConvertObjectToJsonList<SolutionArray>(solutionArr);
                    context.Response.Write(strDetails);
                    break;
            }
        }
