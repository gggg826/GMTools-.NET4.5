            ...
            if (processRequest != null)
            {
                ...
                switch (methodType)
                {
                    ...
                    case HttpMethodType.AddAll:
                        ...
                        break;
                    case HttpMethodType.AsyncToOthers:
                            strResult = processRequest.AsyncToOthers(context);
                        break;
                    ...
                    case HttpMethodType.SendMail:
                        ...
                        break;
                    case HttpMethodType.SendRequest:
                        strResult = processRequest.SendRequest(context);
                        break;
                    default:
                        requestResult = new ResultModel();
                        requestResult.Content = "不支持的method类型";
        ...
        public ProcessRequestBase GetRequestInstance(HttpModuleType moduleType)
        {
            switch (moduleType)
            {
                ...
                case HttpModuleType.PushNotice:
                    return new PushNoticeModule("tbl_baidupush");
                case HttpModuleType.CheckChat:
                    return new CheckChatModule("");
                case HttpModuleType.Orders:
                    return new OrderModule("");
                case HttpModuleType.Logs:
                    return new ProcessRequestBase("tbl_log");
                case HttpModuleType.Activity_Details:
                    return new ActivityItemModule("tbl_activity_details");
                case HttpModuleType.Activity_Solution:
                    return new SolutionModule("tbl_activity_solution");
