...
namespace FengNiao.GMTools.Database.DAL
{
    public partial class tbl_login_rewards_config
    {
		...
		public bool Exists(long record_id)
		{
			...
			strSql.Append("select count(1) from tbl_login_rewards_config");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tbl_login_rewards_config(");
			strSql.Append("serverID,date,kindReward,rewardName1,rewardCount1,rewardName2,rewardCount2,rewardName3,rewardCount3,rewardName4,rewardCount4,dataid)");
			...
			MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@dataid", MySqlDbType.Int32,11)};
            int index = 0;
            ...
            parameters[index++].Value = model.dataid;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tbl_login_rewards_config set ");
		...
		public bool Delete(int record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tbl_login_rewards_config ");
			strSql.Append(" where record_id=@record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@record_id", MySqlDbType.Int32)
			};
		...
		public FengNiao.GMTools.Database.Model.tbl_login_rewards_config GetModel(int record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select record_id,serverID,date,kindReward,rewardName1,rewardCount1,rewardName2,rewardCount2,rewardName3,rewardCount3,rewardName4,rewardCount4,dataid from tbl_login_rewards_config ");
			strSql.Append(" where record_id=@record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@record_id", MySqlDbType.Int32)
			};
			...
			FengNiao.GMTools.Database.Model.tbl_login_rewards_config model=new FengNiao.GMTools.Database.Model.tbl_login_rewards_config();
		...
		/// 得到一个对象实体
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_login_rewards_config DataRowToModel(DataRow row)
		{
			FengNiao.GMTools.Database.Model.tbl_login_rewards_config model=new FengNiao.GMTools.Database.Model.tbl_login_rewards_config();
			if (row != null)
			{
		...
		{
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select record_id,serverID,date,kindReward,rewardName1,rewardCount1,rewardName2,rewardCount2,rewardName3,rewardCount3,rewardName4,rewardCount4,dataid");
            strSql.Append(" FROM tbl_login_rewards_config ");
            if (strWhere.Trim() != "")
            {
        ...
        //    }
        //    strSql.Append(")AS Row, T.*  from tbl_login_rewards_config T ");
