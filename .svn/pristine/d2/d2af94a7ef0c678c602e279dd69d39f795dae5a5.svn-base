...
namespace FengNiao.GMTools.Database.DAL
{
	...
	public partial class tbl_package_server
	{
		...
		public bool Add(FengNiao.GMTools.Database.Model.tbl_package_server model)
		{
			...
			strSql.Append("fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_package_version,fld_visible_group,fld_tester_visible_group)");
			...
			MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@fld_tester_visible_group", MySqlDbType.VarChar,200)};
            ...
            parameters[6].Value = model.fld_tester_visible_group;
		...
		public bool Update(FengNiao.GMTools.Database.Model.tbl_package_server model)
		{
			...
			strSql.Append("fld_modif_time=@fld_modif_time,");
            ...
            strSql.Append("fld_tester_visible_group=@fld_tester_visible_group");
			strSql.Append(" where fld_record_id=@fld_record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@fld_modif_time", MySqlDbType.DateTime),
					new MySqlParameter("@fld_deleted", MySqlDbType.Byte,4),
					new MySqlParameter("@fld_package_name", MySqlDbType.VarChar,255),
					new MySqlParameter("@fld_package_version", MySqlDbType.VarChar,10),
					new MySqlParameter("@fld_visible_group", MySqlDbType.VarChar,200),
			...
			parameters[0].Value = model.fld_modif_time;
            ...
            parameters[5].Value = model.fld_tester_visible_group;
		...
		public FengNiao.GMTools.Database.Model.tbl_package_server GetModel(long fld_record_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fld_record_id,fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_package_version,fld_visible_group,fld_tester_visible_group from tbl_package_server ");
			strSql.Append(" where fld_record_id=@fld_record_id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@fld_record_id", MySqlDbType.Int64)
			};
		...
		public FengNiao.GMTools.Database.Model.tbl_package_server DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
                ...
                if (row["fld_tester_visible_group"] != null && row["fld_tester_visible_group"].ToString() != "")
                {
                    model.fld_tester_visible_group = row["fld_tester_visible_group"].ToString();
                }
            }
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fld_record_id,fld_create_time,fld_modif_time,fld_deleted,fld_package_name,fld_package_version,fld_visible_group,fld_tester_visible_group ");
