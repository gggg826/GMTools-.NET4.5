...
namespace FengNiao.GMTools.Database.BLL
{
	...
	{
		private readonly FengNiao.GMTools.Database.DAL.tbl_package dal=new FengNiao.GMTools.Database.DAL.tbl_package();
		public tbl_package()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public FengNiao.GMTools.Database.Model.tbl_package GetModelByCache(long fld_record_id)
		{
			
			string CacheKey = "tbl_packageModel-" + fld_record_id;
			...
			return (FengNiao.GMTools.Database.Model.tbl_package)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<FengNiao.GMTools.Database.Model.tbl_package> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FengNiao.GMTools.Database.Model.tbl_package> DataTableToList(DataTable dt)
		{
			List<FengNiao.GMTools.Database.Model.tbl_package> modelList = new List<FengNiao.GMTools.Database.Model.tbl_package>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FengNiao.GMTools.Database.Model.tbl_package model;
