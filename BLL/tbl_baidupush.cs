...
namespace FengNiao.GMTools.Database.BLL
{
    ...
    {
        private readonly FengNiao.GMTools.Database.DAL.tbl_baidupush dal = new FengNiao.GMTools.Database.DAL.tbl_baidupush();
        ...
        {
            return dal.UpdateMsg_ID(model, msg_id, timer_id);
        }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public FengNiao.GMTools.Database.Model.tbl_baidupush GetModelByCache(int record_id)
        //{
        ...
        //        catch { }
        //    }
        //    return (FengNiao.GMTools.Database.Model.tbl_baidupush)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_baidupush> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_baidupush> DataTableToList(DataTable dt)
        {
            List<FengNiao.GMTools.Database.Model.tbl_baidupush> modelList = new List<FengNiao.GMTools.Database.Model.tbl_baidupush>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                FengNiao.GMTools.Database.Model.tbl_baidupush model;
