...
namespace FengNiao.GMTools.Database.BLL
{
    ...
    {
        private readonly FengNiao.GMTools.Database.DAL.tbl_sucession_rewards_config dal = new FengNiao.GMTools.Database.DAL.tbl_sucession_rewards_config();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config GetModelByCache(int record_id)
        //{
        ...
        //        catch { }
        //    }
        //    return (FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config> DataTableToList(DataTable dt)
        {
            List<FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config> modelList = new List<FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                FengNiao.GMTools.Database.Model.tbl_sucession_rewards_config model;
