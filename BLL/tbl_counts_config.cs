...
namespace FengNiao.GMTools.Database.BLL
{
    public partial class tbl_counts_config
    {
        ...
        private readonly FengNiao.GMTools.Database.DAL.tbl_counts_config dal = new FengNiao.GMTools.Database.DAL.tbl_counts_config();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public FengNiao.GMTools.Database.Model.tbl_counts_config GetModelByCache(int record_id)
        //{
        ...
        //        catch { }
        //    }
        //    return (FengNiao.GMTools.Database.Model.tbl_counts_config)objModel;
        //}
        ...
        ///// 获得数据列表
        ///// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_counts_config> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FengNiao.GMTools.Database.Model.tbl_counts_config> DataTableToList(DataTable dt)
        {
            ...
            if (rowsCount > 0)
            {
                FengNiao.GMTools.Database.Model.tbl_counts_config model;
